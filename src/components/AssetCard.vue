<script setup>
/**
 * Presentational: one asset price tile. Shows a category-colored accent,
 * label, Toman price, a green/red up/down badge derived from
 * Asset.changeDirection, and a favorite-toggle star. No business logic
 * lives here — everything is props in / events out.
 */
...
<template>
  <article class="asset-card" :style="{ '--accent': accentColor }">
