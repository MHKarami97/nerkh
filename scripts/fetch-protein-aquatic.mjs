...
const SOURCE_URL = 'https://stdt.ir/product-category/meat-aquatic/'
...
async function main() {
  ...
  if (!items.length) { console.error('[fetch-protein-aquatic] debug first 50 lines:', JSON.stringify(lines.slice(0, 50))); throw new Error('Could not parse any non-zero aquatic records') }
  const payload = { source: SOURCE_URL, generatedAt: new Date().toISOString(), sourceUpdatedAt, category: 'پروتئین - آبزیان', currency: 'تومان', items }
