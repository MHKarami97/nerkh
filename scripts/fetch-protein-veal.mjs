...
async function main() {
  ...
  if (!items.length) { console.error('[fetch-protein-veal] debug first 50 lines:', JSON.stringify(lines.slice(0, 50))); throw new Error('Could not parse any non-zero veal records') }
  const payload = { source: SOURCE_URL, generatedAt: new Date().toISOString(), sourceUpdatedAt, category: 'پروتئین - گوساله', currency: 'تومان', items }
